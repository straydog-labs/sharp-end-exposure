...
assert.ok(/repeat\(auto-fill,minmax\(140px,1fr\)\)/.test(detailFn), 'fluid 5-tile grid');
...
assert.ok(/Date', 'Route', 'Grade', 'Type', 'Setting', 'Zone'/.test(detailFn));
...
assert.ok(/bindUserDetailAccordions\(body\)/.test(detailFn));
